...
<template>
  ...
  <pv-toolbar class="mb-4">
    <template #start>
      ...
      <pv-button :disbled="!selectedItems || !selectedItems.length" icon="pi pi-trash" label="Delete" label="Delete"
  ...
  <pv-data-table
    ...
    <pv-column :exportable="false" style="min-width: 8rem">
      <template #body="slotProps">
        ...
        <pv-button icon="pi pi-pencil" outlined rounded severity="danger" @click="confirmDeleteItem(slotProps.data)"/>
      </template>
    </pv-column>
  </pv-data-table>
