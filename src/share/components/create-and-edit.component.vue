  ...
  <pv-dialog v-bind:visible="visible"
    ...
    <template #footer>
      <div class = "flex justify-content-end">
        <pv-button type="button" :label="getSubmitLabel" class="p-button-text" icon="pi pi-check"
                   @click="onSave"/>
        <pv-button type="button" label="Cancel" severity="secondary" class="p-button-text" icon="pi pi-check"
                   @click="onCancel"/>
      </div>
    </template>
  </pv-dialog>
